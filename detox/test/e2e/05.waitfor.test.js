const workaround = require('./workaround');
...
describe('WaitFor', () => {
  ...
  workaround.it.android.rn57Max('should find element by scrolling until it is visible', async () => {
  ...
  // itRN58Min('should find element by scrolling until it is visible', async () => {
  //   let err;
  //   try {
  //     await expect(element(by.text('Text5'))).toBeNotVisible();
  //   } catch (e) {
